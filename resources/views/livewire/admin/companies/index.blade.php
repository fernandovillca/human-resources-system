<div>
    ...
    <div class="mb-4 flex justify-between items-center gap-4">
        <div class="flex-1 max-w-md">
            <flux:input wire:model.live.debounce.300ms="search" placeholder="Buscar compañía..." icon="magnifying-glass" />
        </div>

        <flux:button variant="primary" icon="plus" class="cursor-pointer" :href="route('companies.create')"
            wire:navigate>
            Nueva Compañía
        </flux:button>
    </div>
